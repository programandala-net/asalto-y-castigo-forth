...
: my-holder  ( -- a )  protagonist~ holder ;
  \ Devuelve la localización del protagonista.

: my-previous-holder  ( -- a )  protagonist~ previous-holder  ;
...
: is-hold?  ( a -- f )  holder protagonist~ =  ;
...
: be-hold  ( a -- )  ~holder protagonist~ swap !  ;
...
: be-here  ( a -- )  my-holder swap be-there  ;
