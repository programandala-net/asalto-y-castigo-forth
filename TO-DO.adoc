...
- Crear un directorio para ficheros de configuración.
- Extraer del fichero de configuración la explicación
  y moverla a la documentación general.
- Dividir el fichero de configuración, separando las configuraciones
  de colores.
- Añadir un comando de sistema para cargar un fichero de
  configuración.
- Añadir `incluir_fichero` a los comandos de configuración.
...
Mover `?execute` a Galope y usarlo en vez de `?wrong`.
