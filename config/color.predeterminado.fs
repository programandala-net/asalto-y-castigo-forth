\ config/color.predeterminado.fs

\ Combinación de colores «predeterminado».
...
\ Última modificación: 201607111104
...
gris_claro tinta_de_créditos
negro papel_de_créditos

\ Colores de la narración:

gris_claro tinta_de_narración
...
gris_claro tinta_de_descripción
...
gris_claro tinta_de_error_operativo
